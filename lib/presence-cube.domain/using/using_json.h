...
static cJSON_Delete_func_t using_json__cJSON_Delete_func = cJSON_Delete;

/**
 * @brief frees given JSON document on exception or 
 *        after successful execution of provided code block.
 */
#define USING_JSON(variable, code_block) USING_FUNC(variable, code_block, using_json__cJSON_Delete_func);