...
void draw_scaled_text(
    ...
    log_information(LOGGER_TAG, "Drawing text '%s'(%i) with scale %i and color %i\n", text, text_length, scale_factor, color);
