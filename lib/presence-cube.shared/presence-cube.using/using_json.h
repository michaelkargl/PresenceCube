...
cJSON_Delete_func_t _using_json__cJSON_Delete_func = cJSON_Delete;

/**
 * @brief frees given JSON document on exception or after successful execution of provided code block.
 */
