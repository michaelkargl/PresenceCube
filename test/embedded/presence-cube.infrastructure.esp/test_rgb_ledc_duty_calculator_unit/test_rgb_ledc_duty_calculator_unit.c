    ...
    uint32_t expected)
{
    TEST_PRINTF(
            ...
            expected);
    struct ledc_led_t led = build_ledc_led(is_common_anode, resolution_in_bit, percent);
...
static void testcase_calculate_duty_cycle__given_common_anode_led__returns_duty_cycle(
    ...
    uint32_t expected)
{
    testcase__calculate_duty_cycle__given_led__returns_duty_cycle(true, resolution_in_bit, percent, expected);
}
...
static void testcase__calculate_duty_cycle__given_common_cathode_led__returns_duty_cycle(
    ...
    uint32_t expected)
{
    testcase__calculate_duty_cycle__given_led__returns_duty_cycle(false, resolution_in_bit, percent, expected);
}
...
void test_calculate_duty_percent__given_common_cathode_led__returns_percentage() {
    ...
    struct ledc_led_t led = build_ledc_led(false, bit_resolution, brightness_percent);
...
void test_calculate_duty_percent__given_common_anode_led__returns_percentage() {
    ...
    struct ledc_led_t led = build_ledc_led(true, bit_resolution, brightness_percent);
